...
<html>
    ...
    <body>
        ...
        <form action="question6" method="POST">
            <h1> 6) В какой единице измеряется индуктивность? </h1>				
            <input type="checkbox" name="checkbox" id="1" value="a" checked="true"/> Герман <br>
            <input type="checkbox" name="checkbox" id="2" value="b" /> Генри <br>
            <input type="checkbox" name="checkbox" id="3" value="c" /> Геральд <br>
            <input type="checkbox" name="checkbox" id="4" value="d" /> Генрих <br>
