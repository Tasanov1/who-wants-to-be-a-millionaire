...
<html>
    ...
    <body>
        ...
        <form action="question2" method="POST">
            <h1>2) В каком году была запущена Wikipedia? </h1>				
            <input type="checkbox" name="checkbox" id="1" value="a" checked="true"/> 2000 <br>
            <input type="checkbox" name="checkbox" id="2" value="b" /> 2001 <br>
            <input type="checkbox" name="checkbox" id="3" value="c" /> 1999 <br>
            <input type="checkbox" name="checkbox" id="4" value="d" /> 1998 <br>
