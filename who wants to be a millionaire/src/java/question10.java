 ...
 * @author tassa
 */
@WebServlet(urlPatterns = {"/question10"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) 
        throws ServletException, IOException { 
            ...
            try{  
                ...
                out.print("<a href=\"finish.jsp\">следующий вопрос</a>");
                //Сессия
                ...
                if(ans.equals("b")){
                    ...
                    String queryw = ("update users set tried=true where ipn="+"'"+login+"'");
                    st.executeUpdate(queryw);
