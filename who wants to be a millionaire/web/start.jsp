<%-- 
    Document   : start
    Created on : 22.09.2017, 17:00:27
    Author     : tassa
--%>
...
<html>
    ...
    <body>
        ...
        <form action="question" method="POST">
            <h1>1) За кого вышла замуж Анджелина Джоли в 2014 году? </h1>				
            <input type="checkbox" name="checkbox" id="1" value="a" checked="true"/> Бред Пит <br>
            <input type="checkbox" name="checkbox" id="2" value="b" /> Джастин Бибер <br>
            <input type="checkbox" name="checkbox" id="3" value="c" /> Торегали Тореали <br>
            <input type="checkbox" name="checkbox" id="4" value="d" /> Кайрат Нуртаc <br>
